<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-users"></i> Plan : <?php echo $plan->title ?>
    </h1>
  </section>
        ...
        <div class="row">
          <div class="col-xs-12 text-right">
            <div class="form-group">
              <a class="btn btn-primary" href="#add_new_payment" data-toggle="tab"><i class="fa fa-plus"></i> Add New Payment</a>
            </div>
          </div>
        </div>
        <div class="row">
            ...
            <div class="box">
              ...
              <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                  ...
                  if(!empty($payments))
                  {
                    foreach($payments as $index=>$record)
                    {
                  ?>
                  <tr>
                    <td>
                      <div <?php echo ($record->status==0) ? '' : 'hidden' ?>>
                        <a class="btn btn-sm btn-info opacity-full"
                          href="<?php echo base_url().'payment/approve/1/'.$plan->id.'/'.$record->id; ?>">
                          Approve
                        </a> or <a class="btn btn-sm btn-danger opacity-full"
                          href="<?php echo base_url().'payment/decline/1/'.$plan->id.'/'.$record->id; ?>">
                          Decline
                        </a>
                      </div>
                    </td>
        ...
        <div class="row">
          ...
          <div class="col-xs-12">
            <div class="box box-primary">
              ...
              <form role="form" id="addPayment" action="<?php echo base_url().'payment/create/'.$plan->id ?>" method="post" role="form">
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-6" hidden>                                
                      <div class="form-group">
                        <label for="fname">Select Plan</label>
                        <input type="hidden" class="form-control" id="planId" name="planId" value="<?php echo $plan->id; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
